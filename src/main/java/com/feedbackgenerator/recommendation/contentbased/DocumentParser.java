...
public class DocumentParser {
     ...
     */
    public double tfIdfCalculator(String term) {
    ...
    public static void main(String args[]) {
        ...
        for (int i = 94; i < learningMaterials.size(); i++) {
            ...
            if (avgTf == 0.0) {
                System.out.println(avgTf + " " + learningMaterials.get(i).getUrl() + " " + i);
            }else{
